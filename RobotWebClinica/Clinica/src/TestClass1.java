...
public class TestClass1 {
    ...
    //Variables para inicialización de Selenium
    //==========================================
    ...
    //Variables que utilizadas para controlar el acceso al login de la aplicaición
    //============================================================================
    ...
    public void testprincipal(String nroFlujo,String placa,String nombres,String apPaterno,String apMaterno,String estadoCivil,String nacionalidad,String sexo,String fechaNacimiento,String docIdentidad,String tipoDocumento,String marcaTarjeta, String nroTarjeta, String vencimientoTarjeta, String CVVTarjeta,String departamento,String provincia,String distrito,String direccion,String celular,String clase,String marca,String modelo,String version,String nroSerie,String anhoFabricacion,String uso,String zonaCirculacion) throws InterruptedException, AWTException, Exception{
        ...
        if(ValidaInput(nroFlujo,placa,nombres,apPaterno,apMaterno,estadoCivil,nacionalidad,sexo,fechaNacimiento,docIdentidad,tipoDocumento,marcaTarjeta,nroTarjeta,vencimientoTarjeta,CVVTarjeta,departamento,provincia,distrito,direccion,celular,clase,marca,modelo,version,nroSerie,anhoFabricacion,uso,zonaCirculacion)){
            ...
            try{
                ...
                outputmsj = "Flujo Nº"+nroFlujo+" validado exitosamente";
                ...
                //System.out.println("Dentro de la excepción");
                long TimerTime = (System.currentTimeMillis()-startTime);
                ex.printStackTrace();
                ...
                if(outputmsj.length()==0){
                    if(ex.getClass().getCanonicalName().contains("Timeout")){
                        outputmsj = "Un elemento está demorando en cargar más tiempo del previsto (ver la captura '"+nombreCaptura+"')";
                    }else{
                        outputmsj = "Fallo no identificado (ver la captura '"+nombreCaptura+"')";
                    }
                }
                if(cierre==false){
                    outputmsj = "Fallo durante la ejecución del flujo Nº"+nroFlujo+": "+outputmsj;
                   ...
                   outputmsj = "No es posible la validación del flujo Nº"+nroFlujo+": "+outputmsj;
                   llenarExcel(nroFlujo, placa, nombres, apPaterno, apMaterno,estadoCivil,nacionalidad,sexo,fechaNacimiento, docIdentidad, tipoDocumento, nroTarjeta, "NO OK", outputmsj,tiempoEjecucion,"-");
                }
            }
        }else{
            mensaje = "";
            outputmsj = "Inconsistencia de data para el flujo Nº"+nroFlujo+": "+outputmsj;
    ...
    public void Caso1(String nroFlujo,String placa,String nombres,String apPaterno,String apMaterno,String docIdentidad,String tipoDocumento,int marcaTarjeta, String nroTarjeta, String vencimientoTarjeta, String CVVTarjeta, String departamento, String provincia, String distrito, String direccion, String celular) throws InterruptedException, Exception{
            ...
            //Esperar hasta que salga el mensaje 'Sí, esta maravilla es mía'
            new WebDriverWait(driver,90).until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"lq-module1\"]/div[2]/div[1]/a")));
            
            myElement = driver.findElement(By.xpath("//*[@id=\"lq-module1\"]/div[1]/div[2]/div/div"));
            System.out.println(myElement.getText());
            
            myElement = driver.findElement(By.xpath("//*[@id=\"lq-module1\"]/div[1]/div[3]/div/div"));
            System.out.println(myElement.getText());
            
            myElement = driver.findElement(By.xpath("//*[@id=\"lq-module1\"]/div[1]/div[4]/div/form/div[2]/div[1]/div[2]/span"));
            System.out.println(myElement.getText());
            
            //Click en el botón 'Sí, esta maravilla es mía'
            myElement = driver.findElement(By.xpath("//*[@id=\"lq-module1\"]/div[2]/div[1]/a"));
            myElement.click();
            
            
            //Click al botón 'Sí soy yo' una vez que aparezca
            new WebDriverWait(driver,60).until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"lq-module2\"]/div[2]/div[1]/a")));
            myElement = driver.findElement(By.xpath("//*[@id=\"lq-module2\"]/div[2]/div[1]/a"));
            myElement.click();
            
            //Aparece una oferta y digo "Perfecto"
            new WebDriverWait(driver,60).until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"lq-module3\"]/div[2]/div[1]/a")));
            myElement = driver.findElement(By.xpath("//*[@id=\"lq-module3\"]/div[2]/div[1]/a"));
            myElement.click();
            
            //Confirmo DNI
            new WebDriverWait(driver,60).until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"lq-module4\"]/div[2]/div/form/button/i")));
            myElement = driver.findElement(By.xpath("//*[@id=\"lq-module4\"]/div[2]/div/form/button/i"));
            myElement.click();
            
            //Thread.sleep(360000);
            
            //Confirmamos datos
            new WebDriverWait(driver,60).until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"lq-module5\"]/div[2]/div[1]/a")));
            myElement = driver.findElement(By.xpath("//*[@id=\"lq-module5\"]/div[2]/div[1]/a"));
            myElement.click();
            
            //===================================== direccion
            
            new WebDriverWait(driver,60).until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"lq-module6\"]/div[2]/div/a")));
            
            Thread.sleep(1000);
            
            Select sel_dep = new Select(driver.findElement(By.xpath("//*[@id=\"lq-module6\"]/div[1]/div[3]/div/form/div/div[1]/div/div/select")));
            try{
                sel_dep.selectByVisibleText(departamento.toUpperCase());
            }catch(Exception e){
                outputmsj = "No se encontró el departamento indicado en la lista del chatBot";
                throw new Exception();
            }

            Thread.sleep(1000);
            Select sel_pro = new Select(driver.findElement(By.xpath("//*[@id=\"lq-module6\"]/div[1]/div[3]/div/form/div/div[2]/div/div/select")));
            try{
                sel_pro.selectByVisibleText(provincia.toUpperCase());
            }catch(Exception e){
                outputmsj = "No se encontró la provincia indicada en la lista del chatBot";
                throw new Exception();
            }
            
            Thread.sleep(1000);
            Select sel_dis = new Select(driver.findElement(By.xpath("//*[@id=\"lq-module6\"]/div[1]/div[3]/div/form/div/div[3]/div/div/select")));
            try{
                sel_dis.selectByVisibleText(distrito.toUpperCase());
            }catch(Exception e){
                outputmsj = "No se encontró el distrito indicado en la lista del chatBot";
                throw new Exception();
            }

            Thread.sleep(1000);
            myElement = driver.findElement(By.xpath("//*[@id=\"lq-module6\"]/div[1]/div[3]/div/form/div/div[4]/div/div/input"));
            try{
                myElement.sendKeys(direccion.toUpperCase());
            }catch(Exception e){
                outputmsj = "El chatBot no permite ingresar la dirección especificada";
                throw new Exception();
            }

            Thread.sleep(1000);
            myElement = driver.findElement(By.xpath("//*[@id=\"lq-module6\"]/div[1]/div[3]/div/form/div/div[5]/div/input"));
            try{
            ...
            new WebDriverWait(driver,60).until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"lq-module6\"]/div[2]/div/a")));
            myElement = driver.findElement(By.xpath("//*[@id=\"lq-module6\"]/div[2]/div/a"));
            myElement.click();
            
            //Esperar disponibilidad y luego escribir el correo en el campo de texto
            new WebDriverWait(driver,60).until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"lq-module7\"]/div[2]/div/form/div/input")));
            myElement = driver.findElement(By.xpath("//*[@id=\"lq-module7\"]/div[2]/div/form/div/input"));
            myElement.clear();
            myElement.sendKeys("prueba.ecommerce.positiva@gmail.com");
            
            new WebDriverWait(driver,60).until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"lq-module7\"]/div[2]/div/form/button/i")));        
            myElement = driver.findElement(By.xpath("//*[@id=\"lq-module7\"]/div[2]/div/form/button/i"));
            myElement.click();
            
            //Confirmar la fecha
            new WebDriverWait(driver,60).until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"lq-module8\"]/div[2]/div/form/div/button/i")));        
            myElement = driver.findElement(By.xpath("//*[@id=\"lq-module8\"]/div[2]/div/form/div/button/i"));
            myElement.click();
            ...
            myElement = driver.findElement(By.xpath("//*[@id=\"lq-module9\"]/div[2]/div/form/div[1]/div[1]/span"));
            System.out.println("Tarifa: "+myElement.getText());
            myElement = driver.findElement(By.xpath("//*[@id=\"lq-module9\"]/div[2]/div/form/div[1]/div[2]/div[1]/div[2]/span"));
            System.out.println("Marca: "+myElement.getText());
            myElement = driver.findElement(By.xpath("//*[@id=\"lq-module9\"]/div[2]/div/form/div[1]/div[2]/div[2]/div[2]/span"));
            System.out.println("Modelo: "+myElement.getText());
            myElement = driver.findElement(By.xpath("//*[@id=\"lq-module9\"]/div[2]/div/form/div[1]/div[2]/div[3]/div[2]/span"));
            System.out.println("Placa: "+myElement.getText());
            myElement = driver.findElement(By.xpath("//*[@id=\"lq-module9\"]/div[2]/div/form/div[1]/div[2]/div[4]/div[2]/span"));
            System.out.println("Clase: "+myElement.getText());
            myElement = driver.findElement(By.xpath("//*[@id=\"lq-module9\"]/div[2]/div/form/div[1]/div[2]/div[5]/div[2]/span"));
            System.out.println("Uso: "+myElement.getText());
            myElement = driver.findElement(By.xpath("//*[@id=\"lq-module9\"]/div[2]/div/form/div[1]/div[2]/div[6]/div[2]/span"));
            System.out.println("Zona: "+myElement.getText());
            myElement = driver.findElement(By.xpath("//*[@id=\"lq-module9\"]/div[2]/div/form/div[1]/div[2]/div[7]/div[2]/span"));
            System.out.println("DNI: "+myElement.getText());
            myElement = driver.findElement(By.xpath("//*[@id=\"lq-module9\"]/div[2]/div/form/div[1]/div[2]/div[8]/div[2]/span"));
    ...
    public void Caso8(String nroFlujo,String placa,String nombres,String apPaterno,String apMaterno,String docIdentidad,String tipoDocumento,int marcaTarjeta, String nroTarjeta, String vencimientoTarjeta, String CVVTarjeta) throws InterruptedException, Exception{
            ...
            //Click al botón 'No soy yo' una vez que aparezca
            new WebDriverWait(driver,60).until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"lq-module2\"]/div[2]/div[2]/a/span")));
            myElement = driver.findElement(By.xpath("//*[@id=\"lq-module2\"]/div[2]/div[2]/a/span"));
            myElement.click();
            ...
            //Esperar a que aparezca la dirección
            new WebDriverWait(driver,60).until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"lq-module4\"]/div[2]/div/a")));
            
            Select select;
            
            select = new Select(driver.findElement(By.xpath("//*[@id=\"lq-module4\"]/div[1]/div[3]/div/form/div/div[1]/div/div/select")));
            ...
            if(depa.length()>0){
                ...
                outputmsj = "El chatBot no está devolviendo el departamento";
                throw new Exception();
            }
            
            select = new Select(driver.findElement(By.xpath("//*[@id=\"lq-module4\"]/div[1]/div[3]/div/form/div/div[2]/div/div/select")));
            myElement = select.getFirstSelectedOption();
            ...
            if(prov.length()>0){
                ...
                outputmsj = "El chatBot no está devolviendo la provincia";
                throw new Exception();
            }
            
            select = new Select(driver.findElement(By.xpath("//*[@id=\"lq-module4\"]/div[1]/div[3]/div/form/div/div[3]/div/div/select")));
            myElement = select.getFirstSelectedOption();
            ...
            if(dist.length()>0){
                ...
                outputmsj = "El chatBot no está devolviendo el distrito";
                throw new Exception();
            }
            ...
            if(dic.length()>0){
                ...
                outputmsj = "El chatBot no está devolviendo la direccion";
                throw new Exception();
            }
            ...
            if(cel.length()>0){
                ...
                outputmsj = "El chatBot no está devolviendo un celular";
                throw new Exception();
            }
            ...
            if(tari.length()>0){
                ...
                outputmsj = "El chatBot no está devolviendo una tarifa";
                throw new Exception();
            }
    ...
    public void Caso11(String nroFlujo,String placa,String nombres,String apPaterno,String apMaterno,int estadoCivil,String nacionalidad,int sexo,String fechaNacimiento,String docIdentidad,String tipoDocumento,int marcaTarjeta, String nroTarjeta, String vencimientoTarjeta, String CVVTarjeta,String departamento,String provincia,String distrito,String direccion,String celular, int clase,int marca,String modelo,String version,String nroSerie,String anhoFabricacion,int uso,int zonaCirculacion) throws InterruptedException, Exception{
            ...
            new WebDriverWait(driver,90).until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"lq-module1\"]/div[2]/div/form/div/input")));
            myElement = driver.findElement(By.xpath("//*[@id=\"lq-module1\"]/div[2]/div/form/div/input"));
            myElement.sendKeys(placa);
            
            new WebDriverWait(driver,90).until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"lq-module1\"]/div[2]/div/form/button")));
            myElement = driver.findElement(By.xpath("//*[@id=\"lq-module1\"]/div[2]/div/form/button"));
            myElement.click();
    ...
    public void FlujoTarjeta(String nroFlujo,int marcaTarjeta, String nroTarjeta, String vencimientoTarjeta, String CVVTarjeta, String placa, String docIdentidad) throws InterruptedException, Exception{
        ...
        {
            System.out.println("La tarjeta debe ser válida");
            if(validaTarjeta==1)
            {
                System.out.println("La tarjeta es válida - Es correcto");
            }
            else if(validaTarjeta>1)
            {
                System.out.println("La tarjeta es inválida - Es incorrecto");
                for(int i=0;i<3;i++){
                    if((i==0)&(intTarjeta[i]>1))
                    {
                        System.out.println("Es incorrecto el número de la tarjeta");
                        outputmsj = "Resultado inesperado: El número de la tarjeta es evaluado por el chatBot como incorrecto";
                        throw new Exception();
                    }
                    else if((i==1)&(intTarjeta[i]>1))
                    {
                        System.out.println("Es incorrecta la fecha de expiración");
                        outputmsj = "Resultado inesperado: La fecha de expiración de la tarjeta es evaluada por el chatBot como incorrecta";
                        throw new Exception();
                    }
            ...
            else if(validaTarjeta==0)
            {
                ...
                for(int i=0;i<3;i++){
                    ...
                    {
                        System.out.println("Es indeterminado el número de la tarjeta");
                        outputmsj = "Resultado inesperado: El número de la tarjeta no es evaluado por el chatBot";
                        throw new Exception();
                    }
                    else if((i==1)&(intTarjeta[i]==0))
                    {
                        System.out.println("Es indeterminado la fecha de expiración");
                        outputmsj = "Resultado inesperado: La fecha de expiración de la tarjeta no es evaluada por el chatBot";
                        throw new Exception();
                    }
        ...
        {
            System.out.println("La tarjeta debe ser inválida");
            if(validaTarjeta==1)
            {
                System.out.println("La tarjeta es (aparentemente) válida - Es (aparentemente) incorrecto");
                
                System.out.println("La tarjeta es válida - Es incorrecto(aparentemente)");
                casoExcepcion = true;
            }
            else if(validaTarjeta>1)
            {
                System.out.println("La tarjeta es inválida - Es correcto");
                casoInvalida = true;
            }
            else if(validaTarjeta==0)
            {
    ...
    public boolean ValidaInput(String nroFlujo,String placa,String nombres,String apPaterno,String apMaterno,String estadoCivil,String nacionalidad,String sexo,String fechaNacimiento,String docIdentidad,String tipoDocumento,String marcaTarjeta, String nroTarjeta, String vencimientoTarjeta, String CVVTarjeta,String departamento,String provincia,String distrito,String direccion,String celular,String clase,String marca,String modelo,String version,String nroSerie,String anhoFabricacion,String uso,String zonaCirculacion) throws ParseException{
        ...
        String [] PolizaVigenteVal = {"Póliza existe, tiene fin de vigencia y no expiró","Póliza existe, tiene fin de vigencia y ya expiró","Póliza existe pero no tiene fin de vigencia","Poliza no existe"};
        String [] TarjetaValidaVal = {"Tarjeta válida","Tarjeta inválida"};
        ...
        try{
            ...
            ex.printStackTrace();
            outputmsj = outputmsj+"El campo 'nroFlujo' debe contener un valor numérico\n";
            mensaje = mensaje + "El campo 'nroFlujo' debe contener un valor numérico - ERROR\n";
            return false;   
        }
        ...
        if(encontrado==false){
                outputmsj = outputmsj+"El campo 'nroFlujo' no corresponde a un flujo considerado en esta versión.\n";
                return false;
        }
        ...
        try{
            ...
            outputmsj = outputmsj+"El campo 'fechaNacimiento' no posee un formato válido. Introduzca una fecha en el formato dd/MM/yyyy.\n";
            return false;
        }
        
        String sdep = departamento;
        if(sdep== null || !sdep.replace(" ","").matches("^[a-zA-Z]*$")){
            outputmsj = outputmsj+"El campo 'departamento' no posee un formato válido.\n";
            return false;
        }
        
        String spro = provincia;
        if(spro== null || !spro.replace(" ","").matches("^[a-zA-Z]*$")){
            outputmsj = outputmsj+"El campo 'provincia' no posee un formato válido.\n";
            return false;
        }
        
        String sdis = distrito;
        if(sdis== null || sdis.length()==0){
            outputmsj = outputmsj+"El campo 'distrito' no posee un formato válido.\n";
            return false;
        }
        
        String sdir = direccion;
        if(sdir== null || sdis.length()==0){
            outputmsj = outputmsj+"El campo 'direccion' no posee un formato válido.\n";
            return false;
        }
        ...
        try{
            ...
            if(celular.length()!=9){
                outputmsj = outputmsj+"El campo 'celular' no tiene el tamaño adecuado.\n";
                return false;
            }
        }catch(Exception excep){
            outputmsj = outputmsj+"El campo 'celular' no posee un formato válido.\n";
            return false;
        }
        ...
        */
        ...
        mensaje = mensaje+"La condición 'PlacaExistente' dio como resultado: '"+PlacaExisteVal[valor-1]+"'";
        ...
        mensaje = mensaje+"La condición 'ContratanteAsociado' dio como resultado: '"+ContratanteAsociadoVal[valor-1]+"'";
        if(!esperado.contains(""+valor)){
            mensaje = mensaje + " - ERROR\n";
        ...
        mensaje = mensaje+"La condición 'ClienteExistente' dio como resultado: '"+ClienteExisteVal[valor-1]+"'";
        if(!esperado.contains(""+valor)){
            mensaje = mensaje + " - ERROR\n";
        ...
        mensaje = mensaje+"La condición 'PolizaVigente' dio como resultado: '"+PolizaVigenteVal[valor-1]+"'";
        if(!esperado.contains(""+valor)){
            mensaje = mensaje + " - ERROR\n";
        ...
        mensaje = mensaje+"La condición 'TarjetaValida' dio como resultado: '"+TarjetaValidaVal[valor-1]+"'";
        if(!esperado.contains(""+valor)){
            mensaje = mensaje + " - ERROR\n";
    ...
    public void ValidaOutput(String nroFlujo,String placa, String documento) throws InterruptedException, SQLException, Exception{
        ...
        try{
            ...
            if(output_data[iFlujo][0].contains("1")|output_data[iFlujo][1].contains("1")){
                outputmsj = "No es posible verificar la póliza emitida";
                cierre = true;
                throw new Exception();
            }
        }
        ...
        if(conexion.poliza.length()<=0){
            ...
            if(output_data[iFlujo][1].contains("2")){
                outputmsj = "Es posible verificar la póliza cuando no debería haberse emitido";
                cierre = true;
                throw new Exception();
            }
            else{
