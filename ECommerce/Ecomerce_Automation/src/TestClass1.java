...
*/            
            ...
            System.out.println("========================== CONFIRMACIÃ“N ===============================");
...
*/
        ...
        */
        ...
        try{
            ...
            outputmsj = "El chatBot no permite ingresar el nÃºmero de celular especificado";
            throw new Exception();
        }
    ...
    public void FlujoTarjeta(String nroFlujo,int marcaTarjeta, String nroTarjeta, String vencimientoTarjeta, String CVVTarjeta, String placa, String docIdentidad) throws InterruptedException, Exception{
        ...
        //Introduce el nÃºmero de la tarjeta
        ...
        //Valida el nÃºmero de la tarjeta
